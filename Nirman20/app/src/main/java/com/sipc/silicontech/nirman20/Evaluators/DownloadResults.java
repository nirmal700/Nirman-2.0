                            ...
                            for (DocumentSnapshot document1 : queryDocumentSnapshots.getDocuments()) {
                                FirebaseFirestore.getInstance().collection("HackNation Evaluation").whereEqualTo("mTeamName", document1.get("mTeamName")).addSnapshotListener(new EventListener<QuerySnapshot>() {
                                    ...
                                    public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                                        ...
                                        FirebaseFirestore.getInstance().collection("HackNation").document(document1.get("mTeamName").toString()).update("mFinalMark", avg).addOnSuccessListener(new OnSuccessListener<Void>() {
                                            @Override
...
//2-02
                    ...
                    mCollectionReferenceIdeate.get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                        @Override
                        public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                            for (DocumentSnapshot document1 : queryDocumentSnapshots.getDocuments()) {
                                FirebaseFirestore.getInstance().collection("Ideate Evaluation").whereEqualTo("mTeamName", document1.get("mTeamName")).addSnapshotListener(new EventListener<QuerySnapshot>() {
                                    @Override
                                    public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                                        double sum = 0;
                                        for (DocumentSnapshot document : value.getDocuments()) {
                                        ...
                                        double avg = sum / value.size();
                                        FirebaseFirestore.getInstance().collection("Ideate").document(document1.get("mTeamName").toString()).update("mFinalMark", avg).addOnSuccessListener(new OnSuccessListener<Void>() {
                                            @Override
                                            public void onSuccess(Void unused) {
                                                FirebaseFirestore.getInstance().collection("Ideate").orderBy("mFinalMark", Query.Direction.DESCENDING).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                                                    @Override
                                                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                                                        List<DocumentSnapshot> snapshotList = queryDocumentSnapshots.getDocuments();
                                                        for (DocumentSnapshot documentSnapshot : snapshotList) {
