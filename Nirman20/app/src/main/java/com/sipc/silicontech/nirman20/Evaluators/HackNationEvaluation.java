...
public class HackNationEvaluation {
    ...
    public HackNationEvaluation() {

    }

    public HackNationEvaluation(String mTeamName, String mCollegeName, String mProblemStat, String mApproach, String mSuggestion, int mMark1, int mMark2, int mMark3, int mMark4,Double mAvg,Date mEvaluatedTime) {
